---
title: springmvc学习笔记-springmvc整合mybatis遇到的问题及解决小结
date: 2017-06-27 09:25:00
author: jpzhang
top: false
mathjax: false
categories: 开源框架
...
编写对应的转换类才行,具体参考前面参数绑定的博文[《 springmvc学习笔记-springmvc注解开发之简单参数绑定》](http://blog.csdn.net/h3243212/article/details/50854748#自定义参数绑定实现日期类型绑定)
...
其中`<list>`标签会报红，但不影响运行。去掉`<list>`标签，也可以运行成功。
